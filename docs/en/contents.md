---
title: "Contents"
description: "The complete learning path from first expressions to practical F# applications."
translationKey: contents
---

# Contents {#overview}

If F# is new to you, read Parts I–III in order. Later parts build on that foundation and may be read when you need their topics.

## Before you begin {#start}

- [Preface: How to Use This Book](./preface/)
...
## Exercises and solutions {#solutions}
