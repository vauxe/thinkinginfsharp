...
::: tip 分两轮阅读
初读时依次掌握[部署层次](#deployment-contracts)、[选型方法](#compute-decision-map)和[本地验证切片](#verified-slice)。准备真实部署时，再阅读[发布方案](#release-observe-rollback)、[证据阶梯](#evidence-ladder)和[采用试验](#adoption-spike)。
:::
