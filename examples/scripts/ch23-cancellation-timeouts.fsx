...
// #endregion cancellation-operation
...
// #endregion abandon-wait

// #region controlled-timeout
type WaitOutcome<'T> =
    | Completed of 'T
    | TimedOut
...
// #endregion disposal-types

// #region sync-disposal
